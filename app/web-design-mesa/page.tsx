...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.sunstatedevworks.com/web-design-mesa',
  },
  openGraph: {
    url: 'https://www.sunstatedevworks.com/web-design-mesa',
    title: 'Web Design Mesa AZ | Sunstate DevWorks',
...
const localReasons = [
  'Mesa is one of the largest cities in the US — a diverse economy spanning healthcare, education, manufacturing, and retail. We know how to position local Mesa businesses effectively online.',
  ...
  'In-person meetings available. We are right next door in Gilbert — a quick drive with no scheduling overhead.',
    ...
    <>
      ...
      <section style={{ padding: '160px 24px 100px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontFamily: 'Space Mono, monospace', fontSize: 11, color: 'var(--cyan)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 20 }}>Mesa, AZ — East Valley</p>
      ...
      <section style={{ padding: '100px 24px', textAlign: 'center', background: 'var(--navy-mid)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <p style={{ fontFamily: 'Space Mono, monospace', fontSize: 11, color: 'var(--cyan)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 20 }}>Based in Gilbert, AZ · Serving Mesa</p>
