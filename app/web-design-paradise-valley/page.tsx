...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'luxury website design Paradise Valley',
    'custom website Paradise Valley AZ',
    'website developer Paradise Valley AZ',
    'high-end web design Paradise Valley',
    'Paradise Valley Arizona digital agency',
    'web development Paradise Valley AZ',
      ...
      <section style={{ padding: '100px 24px', background: 'var(--navy-mid)', position: 'relative' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(28px, 4vw, 52px)', lineHeight: 1.0, letterSpacing: '-0.02em', marginBottom: 56 }}>
            Full-stack digital<br /><span style={{ color: 'var(--cyan)' }}>for Paradise Valley businesses</span>
          </h2>
