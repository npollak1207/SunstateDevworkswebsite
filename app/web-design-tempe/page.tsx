...
export const metadata: Metadata = {
  ...
  description: 'Custom web design in Tempe, AZ for startups, restaurants, and young brands near ASU. Hand-coded websites, mobile apps, branding & AI automation. No templates.',
  keywords: [
    'web design Tempe AZ',
    'web designer Tempe Arizona',
    'custom website Tempe AZ',
    'startup web design Tempe',
    'ASU area web design',
    'Tempe digital agency',
    'restaurant website Tempe AZ',
    'web development Tempe Arizona',
    'branding agency Tempe AZ',
      ...
      <section style={{ padding: '160px 24px 100px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 18, lineHeight: 1.8, maxWidth: 560, marginBottom: 40 }}>
            Sunstate DevWorks builds custom websites, mobile apps, branding, and AI tools for Tempe startups, restaurants, and emerging brands. Fast delivery, clean code, and digital products built to grow with your business.
          </p>
      ...
      <section style={{ padding: '100px 24px', background: 'var(--navy-mid)', position: 'relative' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(28px, 4vw, 52px)', lineHeight: 1.0, letterSpacing: '-0.02em', marginBottom: 56 }}>
            Full-stack digital<br /><span style={{ color: 'var(--cyan)' }}>for Tempe businesses</span>
          </h2>
