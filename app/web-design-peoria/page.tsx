...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'custom website Peoria AZ',
    'website developer Peoria AZ',
    'small business web design Peoria',
    'West Valley web design',
    'Peoria Arizona digital agency',
      ...
      <section style={{ padding: '100px 24px', background: 'var(--navy-mid)', position: 'relative' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(28px, 4vw, 52px)', lineHeight: 1.0, letterSpacing: '-0.02em', marginBottom: 56 }}>
            Full-stack digital<br /><span style={{ color: 'var(--cyan)' }}>for Peoria businesses</span>
          </h2>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }} className="loc-two-col">
          <div>
            ...
            <h2 style={{ fontFamily: 'Syne, sans-serif', fontWeight: 800, fontSize: 'clamp(26px, 3.5vw, 48px)', lineHeight: 1.05, letterSpacing: '-0.02em', marginBottom: 16 }}>
              Why choose a local<br /><span style={{ color: 'var(--orange)' }}>Peoria web agency?</span>
            </h2>
            <p style={{ color: 'var(--text-muted)', fontSize: 15, lineHeight: 1.8 }}>We serve Peoria businesses with the same custom-code approach that has worked for clients across the entire Phoenix metro.</p>
          </div>
